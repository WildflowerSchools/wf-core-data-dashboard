...
def groups_table_html(
    ...
    groups.columns = [
        [
            ...
            'RIT score growth', 'RIT score growth', 'RIT score growth',
            'Percentile growth', 'Percentile growth', 'Percentile growth',
            'Percentile growth per school year', 'Percentile growth per school year'
        ],
        [
            'N', 'Avg', 'SE',
            'N', 'Avg', 'SE',
